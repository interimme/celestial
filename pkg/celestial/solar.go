...
// Calculate the time in the UTC timezone when the sun transits the specified zenith
// Args:
//
...
// Raises:
//
//	ValueError if the zenith is not transited by the sun
//
// Returns:
//
